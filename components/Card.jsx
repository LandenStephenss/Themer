...
module.exports = class Card extends React.Component {
  ...
  render () {
    return ( 
    <div class="powercord-plugin cardPrimary-1Hv-to card-3Qj_Yx" style={{color: "#dcddde", marginTop: "20px", marginBottom: "20px", padding: "10px", lineHeight: "22px"}}>
        ...
        <br/>
        <div class="powercord-plugin-container"><div class="author"><span><span style={{color: "#738adb"}}>Author: </span> {this.theme.manifest.author}</span></div><div class="version"><span><span style={{color: "#738adb"}}>Version: </span>{this.theme.manifest.version}</span></div><div class="license"><span><span style={{color: "#738adb"}}>Licence: </span>{this.theme.manifest.license}</span><div tabindex="0" role="button"></div></div><div class="description"><span><span style={{color: "#738adb"}}>Description: </span>{this.theme.manifest.description}</span></div></div>
  </div>
  )
  }
